...
export const optionSection = "/options/";
...
export type AttributeListUrlQueryParams = ActiveTab &
  ...
  Pagination;
export const attributeListPath = optionSection;
export const optionListUrl = (params?: AttributeListUrlQueryParams) =>
...
export type AttributeAddUrlQueryParams = Dialog<AttributeAddUrlDialog> &
  SingleAction;
export const attributeAddPath = urlJoin(optionSection, "add");
...
export type AttributeUrlQueryParams = BulkAction &
  ...
  SingleAction;
export const attributePath = (id: string) => urlJoin(optionSection, id);
